...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("365 days in a year"), False)
        self.assertEqual(pythonBasics3.starts_with_non_number("This is a test"), True)
        self.assertEqual(pythonBasics3.starts_with_non_number("_ is an underscore"), True)
